...
In this session, we will place a special emphasis on bivariate relationships. We will ll delve into statistical testing methods, employing tools like t-tests, chi-squared tests. Subsequently, we will learn how to construct simple linear regression models in R, manipulate their output to assess results, and evaluate their fit

-   Session 5 : Correlation and simple linear regression

This session will focus on correlation and simple linear regression. We will learn how to compute correlation coefficients and run simple linear regression models in R. We will also explore how to manipulate their output to assess results and evaluate their fit.
