...
The concept of working directory : place where R look for and save the files we use.

```{r}
getwd()
```

Use R projects, the idea is that when you want to conduct a new data analysis project, you create an R project.