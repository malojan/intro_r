...
To navigate the paths of your projects even better, you use the `here` package. If you want to know more about it, visit the [page](https://here.r-lib.org/articles/here.html) of the package. 
...
```{r}
ggtrend <- readr::read_csv("data/ggtrend_datascience.csv")
ggtrend
```
...
```{r}
readr::write_csv(ggtrend, "data/ggtrend_datascience.csv")
```
